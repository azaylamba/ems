...
You have to design & build the backend for the application and the ability for the users to register, add employees, add salary etc.
...
https://github.com/azaylamba/ems 
